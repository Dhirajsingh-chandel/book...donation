...
class Book_Donate extends StatefulWidget {
  const Book_Donate({
    Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return Book_DonateState();
  }
}

class Book_DonateState extends State<Book_Donate> {
  ...
  Widget _buildauthor() {
    return TextFormField(
      decoration: InputDecoration(labelText: 'Author',
        prefixIcon: Icon(
          Icons.admin_panel_settings_sharp, color: Colors.black,),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(70),
          borderSide: BorderSide(color: Colors.black,
          ),
